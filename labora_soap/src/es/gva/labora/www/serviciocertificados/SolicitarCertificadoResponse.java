...
/**
 * SolicitarCertificadoResponse.java
 *
 ...
 */
            ...
            /**
            *  SolicitarCertificadoResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SolicitarCertificadoResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.labora.gva.es/ServicioCertificados/",
                "SolicitarCertificadoResponse",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for Certificado
                        */

                        
                                    protected es.gva.labora.www.serviciocertificados.Certificado localCertificado ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isCertificadoSpecified(){
                               return localCertificadoTracker;
                           }
                           ...
                           */
                           public  es.gva.labora.www.serviciocertificados.Certificado getCertificado(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Certificado
                               */
                               public void setCertificado(es.gva.labora.www.serviciocertificados.Certificado param){
                            localCertificadoTracker = param != null;
                                   
                                            this.localCertificado=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SolicitarCertificadoResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SolicitarCertificadoResponse",
                           xmlWriter);
                              ...
                              if (localMensajeTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localCertificadoTracker){
                                            if (localCertificado==null){
                                                 throw new org.apache.axis2.databinding.ADBException("certificado cannot be null!!");
                                            }
                                           localCertificado.serialize(new javax.xml.namespace.QName("","certificado"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localCertificado);
                                }
    ...
    public static class Factory{
        ...
        */
        public static SolicitarCertificadoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SolicitarCertificadoResponse object =
                new SolicitarCertificadoResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SolicitarCertificadoResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SolicitarCertificadoResponse)es.gva.labora.www.serviciocertificados.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","certificado").equals(reader.getName())){
                                
                                                object.setCertificado(es.gva.labora.www.serviciocertificados.Certificado.Factory.parse(reader));
