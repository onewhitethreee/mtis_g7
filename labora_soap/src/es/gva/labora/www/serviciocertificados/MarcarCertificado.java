 ...
 */
            ...
            /**
            *  MarcarCertificado bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class MarcarCertificado
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MarcarCertificado",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MarcarCertificado",
    ...
    public static class Factory{
        ...
        */
        public static MarcarCertificado parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MarcarCertificado object =
                new MarcarCertificado();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MarcarCertificado".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MarcarCertificado)es.gva.labora.www.serviciocertificados.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
