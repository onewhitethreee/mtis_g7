 ...
 */
            ...
            /**
            *  SolicitarCertificado bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SolicitarCertificado
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SolicitarCertificado",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SolicitarCertificado",
    ...
    public static class Factory{
        ...
        */
        public static SolicitarCertificado parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SolicitarCertificado object =
                new SolicitarCertificado();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SolicitarCertificado".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SolicitarCertificado)es.gva.labora.www.serviciocertificados.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
