 ...
 */
            ...
            /**
            *  VerificarPrivilegios bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class VerificarPrivilegios
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VerificarPrivilegios",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VerificarPrivilegios",
    ...
    public static class Factory{
        ...
        */
        public static VerificarPrivilegios parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VerificarPrivilegios object =
                new VerificarPrivilegios();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VerificarPrivilegios".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VerificarPrivilegios)es.gva.labora.www.servicioidentidad.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
