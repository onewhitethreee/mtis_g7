...
/**
 * ObtenerCandidatosResponse.java
 *
 ...
 */
            ...
            /**
            *  ObtenerCandidatosResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerCandidatosResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ObtenerCandidatosResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ObtenerCandidatosResponse",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerCandidatosResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerCandidatosResponse object =
                new ObtenerCandidatosResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ObtenerCandidatosResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerCandidatosResponse)es.gva.labora.www.serviciomatching.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
