 ...
 */
            ...
            /**
            *  EjecutarMatchingResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EjecutarMatchingResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EjecutarMatchingResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EjecutarMatchingResponse",
    ...
    public static class Factory{
        ...
        */
        public static EjecutarMatchingResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EjecutarMatchingResponse object =
                new EjecutarMatchingResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EjecutarMatchingResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EjecutarMatchingResponse)es.gva.labora.www.serviciomatching.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
